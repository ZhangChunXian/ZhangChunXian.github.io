...
![image-20200929142625325](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20200929142625325-1601949350254.png)
...
+ 向量寄存器能容纳一个或多个整数或者浮点数。
  ...
  ![](../文档/GitHub/ZhangChunXian.github.io/source/images/bc4fgr6WeEOPw5i.png)
...
![image-20200929200544859](CSAPP%E6%9C%BA%E5%99%A8%E7%BA%A7%E8%A1%A8%E7%A4%BA%E5%9F%BA%E7%A1%80.assets/image-20200929200544859.png)
...
![image-20200929183022928](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20200929183022928.png)
...
![IMG_1095(20200929-184140)](../文档/GitHub/ZhangChunXian.github.io/source/images/IMG_1095(20200929-184140).JPG)

这个代码与之前`mstore.c`文件反编译得到的几乎一致。

`mstore.c`反编译结果（部分）

![image-20200929183022928](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20200929183022928-1601949386047.png)
...
![image-20201006130849519](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006130849519.png)

### 3.2.3 汇编语言格式

本课程采用的是`AT&T`格式汇编语言。格式为：

![image-20201006133443721](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006133443721.png)
...
![C数据类型在x86-64中的大小](../文档/GitHub/ZhangChunXian.github.io/source/images/IMG_1098(20201006-135031).JPG)
...
一个x86-64指令集下的CPU包含一组16个存储64位值的通用寄存器(`general-purpose register`)。这些寄存器用来存储整数和指针数据。它们的名字以`%r`开头，但是由于历史原因，之后的名称命令规则就不同了。![IMG_1099(20201006-140309)](../文档/GitHub/ZhangChunXian.github.io/source/images/IMG_1099(20201006-140309).JPG)
...
![image-20201006153832873](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006153832873.png)

##### move指令实例

![image-20201006163553131](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006163553131.png)

`ret`代表是C语言中的过程返回操作，类似`return`。

函数调用前

![image-20201006164033124](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006164033124.png)

函数调用后

![image-20201006164236498](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006164236498.png)

#### 完全内存寻址模式

在x86汇编指令中，内存寻址是十分灵活的。

![image-20201006183926488](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006183926488.png)
...
![image-20201006185602512](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006185602512.png)
...
![image-20201006195213558](../文档/GitHub/ZhangChunXian.github.io/source/images/image-20201006195213558.png)
