...
前言：在知乎上听大牛说编程直接上项目就是干，以项目为导向，以开发为目标，效果非常好。正巧最近想学python，故尝试以零基础做小项目，疑难部分通过谷歌和书本解决，并通过发表博文检验和锤炼学习成果。

本文结构的思维导图：

![](images/Snake/贪吃蛇 —— Python 小项目实战.png)
...
#5处的`pygame.K_RIGHT`是Pygame库中的属性，作用是使创建的对象（在这里是贪吃蛇）向右运动
