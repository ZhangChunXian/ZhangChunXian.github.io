...
### 1.anki的基础功能，就是提供知识卡片的实时自定义复习——自定义复习知识的频率，数量和时间。这一切都是软件自动去部署，分配的。前期导入知识卡片后，使用者只需关注知识本身——复习计划什么的交给软件。
...
#### 3. anki更多进阶用法详见anki官网，本人博客未来也会更新。
...
#### 4. 软件没有沉没机制，未复习卡片会一天天累加，需要日日清。比如我大一暑假一个月没有用anki,待复习卡片数量暴涨到5000多。当然，直接删除牌组就什么事都木有了。
